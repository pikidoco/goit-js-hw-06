...
//Folosiți matricea de obiecte images, pentru a crea elementele < img > imbricate în < li >.Pentru a crea marcajul,
    //vor fi de mare ajutor template strings și metoda insertAdjacentHTML().
...
images.forEach((image) => {
  ...
  imageLi.insertAdjacentHTML("afterbegin", `<img src=${image.url}" alt="${image.alt}">`);
  galleryList.append(imageLi);
});
